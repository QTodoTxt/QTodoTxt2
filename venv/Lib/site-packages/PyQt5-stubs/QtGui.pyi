...
class QPixmap(QPaintDevice):
    ...
    def devicePixelRatio(self) -> float: ...  # type: ignore  # fixes issue #2
...
class QBitmap(QPixmap):
    ...
    def swap(self, other: 'QBitmap') -> None: ...  #type: ignore  # fixes issue #2
    def transformed(self, matrix: 'QTransform') -> 'QBitmap': ...  # type: ignore  # fixes issue #2
    @staticmethod
...
class QImage(QPaintDevice):
    ...
    def setDevicePixelRatio(self, scaleFactor: float) -> None: ...
    def devicePixelRatio(self) -> float: ...  # type: ignore  # fixes issues #2
...
class QMatrix4x4(sip.simplewrapper):
    ...
    @typing.overload
    def map(self, point: QtCore.QPointF) -> QtCore.QPointF: ...  # fixes issue #3
    @typing.overload
...
class QWindow(QtCore.QObject, QSurface):
    ...
    def setParent(self, parent: 'QWindow') -> None: ...  # type: ignore  # fixes issue #2
    @typing.overload
...
class QPaintDeviceWindow(QWindow, QPaintDevice):  # type: ignore  # fixes issue #5
...
class QPdfWriter(QtCore.QObject, QPagedPaintDevice):
    ...
    def setPageSizeMM(self, size: QtCore.QSizeF) -> None: ...
    def setPageSize(self, size: QPagedPaintDevice.PageSize) -> None: ...  # type: ignore  # fixes issue #2
    def newPage(self) -> bool: ...
...
class QTextList(QTextBlockGroup):
    ...
    def setFormat(self, aformat: QTextListFormat) -> None: ...  # type: ignore  # fixes issue #2
...
class QTextTable(QTextFrame):
    ...
    def setFormat(self, aformat: QTextTableFormat) -> None: ...  # type: ignore  # fixes issue #2
    def format(self) -> QTextTableFormat: ...  # type: ignore  # fixes issue #2
