...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    customContextMenuRequested: QtCore.pyqtSignal  # fix issue #5
...
class QAbstractButton(QWidget):
    ...
    toggled: QtCore.pyqtSignal  # fix issue #5
...
class QAbstractItemView(QAbstractScrollArea):
    ...
    iconSizeChanged: QtCore.pyqtSignal  # fix issue #5
...
class QAction(QtCore.QObject):
    ...
    triggered: QtCore.pyqtSignal  # fix issue #5
...
class QCheckBox(QAbstractButton):
    ...
    stateChanged: QtCore.pyqtSignal  # fix issue #5
...
class QDialog(QWidget):
    ...
    accepted: QtCore.pyqtSignal  #fix issue #5
...
class QComboBox(QWidget):
    ...
    currentIndexChanged: QtCore.pyqtSignal  # fix issue #5
...
class QDialogButtonBox(QWidget):
    ...
    rejected: QtCore.pyqtSignal  # fix issue #5
...
class QFileSystemModel(QtCore.QAbstractItemModel):
    ...
    def hasChildren(self, parent: QtCore.QModelIndex = ...) -> bool: ...
    def parent(self, child: QtCore.QModelIndex) -> QtCore.QModelIndex: ...  # type: ignore  # fix issue #1
    @typing.overload
    def index(self, row: int, column: int, parent: QtCore.QModelIndex = ...) -> QtCore.QModelIndex: ...
    @typing.overload
    def index(self, path: str, column: int = ...) -> QtCore.QModelIndex: ...
...
class QGraphicsPixmapItem(QGraphicsItem):
    ...
    def opaqueArea(self) -> QtGui.QPainterPath: ...
    def isObscuredBy(self, item: QGraphicsItem) -> bool: ...
    def paint(self, painter: QtGui.QPainter, option: 'QStyleOptionGraphicsItem', widget: QWidget) -> None: ...  # type: ignore  # fix issue #1
    def contains(self, point: typing.Union[QtCore.QPointF, QtCore.QPoint]) -> bool: ...
    def shape(self) -> QtGui.QPainterPath: ...
    def boundingRect(self) -> QtCore.QRectF: ...
    @typing.overload
...
class QGraphicsProxyWidget(QGraphicsWidget):
    ...
    def type(self) -> int: ...
    def paint(self, painter: QtGui.QPainter, option: 'QStyleOptionGraphicsItem', widget: QWidget) -> None: ...  # type: ignore  # fix issue #1
    def setGeometry(self, rect: QtCore.QRectF) -> None: ...  # type: ignore  # fix issue #1
...
class QGraphicsScene(QtCore.QObject):
    ...
    focusItemChanged: QtCore.pyqtSignal
    changed: QtCore.pyqtSignal
...
class QGraphicsView(QAbstractScrollArea):
    ...
    def render(self, painter: QtGui.QPainter, target: QtCore.QRectF = ..., source: QtCore.QRect = ..., mode: QtCore.Qt.AspectRatioMode = ...) -> None: ...  # type: ignore  # fix issue #1
    @typing.overload
...
class QHeaderView(QAbstractItemView):
    ...
    def isIndexHidden(self, index: QtCore.QModelIndex) -> bool: ...
    def indexAt(self, p: QtCore.QPoint) -> QtCore.QModelIndex: ...
    def scrollTo(self, index: QtCore.QModelIndex, hint: QAbstractItemView.ScrollHint) -> None: ...  # type: ignore  # fix issue #1
    def visualRect(self, index: QtCore.QModelIndex) -> QtCore.QRect: ...
    def rowsInserted(self, parent: QtCore.QModelIndex, start: int, end: int) -> None: ...
    def dataChanged(self, topLeft: QtCore.QModelIndex, bottomRight: QtCore.QModelIndex, roles: typing.Iterable[int] = ...) -> None: ...
    def scrollContentsBy(self, dx: int, dy: int) -> None: ...
...
class QLineEdit(QWidget):
    ...
    textEdited: QtCore.pyqtSignal  # fix issue # 5
...
class QListWidget(QListView):
    ...
    def closePersistentEditor(self, item: QListWidgetItem) -> None: ...  # type: ignore  # fix issue #1
    def openPersistentEditor(self, item: QListWidgetItem) -> None: ...  # type: ignore  # fix issue #1
...
class QPlainTextEdit(QAbstractScrollArea):
    ...
    def toPlainText(self) -> str: ...
    @typing.overload # type: ignore  # fix issue #2
...
class QProxyStyle(QCommonStyle):
    ...
    def standardPalette(self) -> QtGui.QPalette: ...
    def generatedIconPixmap(self, iconMode: QtGui.QIcon.Mode, pixmap: QtGui.QPixmap, opt: 'QStyleOption') -> QtGui.QPixmap: ...
    def standardPixmap(self, standardPixmap: QStyle.StandardPixmap, opt: 'QStyleOption', widget: typing.Optional[QWidget] = ...) -> QtGui.QPixmap: ...  # type: ignore  # fix issue #2
    def standardIcon(self, standardIcon: QStyle.StandardPixmap, option: typing.Optional['QStyleOption'] = ..., widget: typing.Optional[QWidget] = ...) -> QtGui.QIcon: ...
    def layoutSpacing(self, control1: 'QSizePolicy.ControlType', control2: 'QSizePolicy.ControlType', orientation: QtCore.Qt.Orientation, option: typing.Optional['QStyleOption'] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    def pixelMetric(self, metric: QStyle.PixelMetric, option: typing.Optional['QStyleOption'] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    ...
    def itemPixmapRect(self, r: QtCore.QRect, flags: int, pixmap: QtGui.QPixmap) -> QtCore.QRect: ...
    def itemTextRect(self, fm: QtGui.QFontMetrics, r: QtCore.QRect, flags: int, enabled: bool, text: str) -> QtCore.QRect: ...
    def subControlRect(self, cc: QStyle.ComplexControl, opt: 'QStyleOptionComplex', sc: QStyle.SubControl, widget: QWidget) -> QtCore.QRect: ...  # type: ignore  # fix issue #2
    def subElementRect(self, element: QStyle.SubElement, option: 'QStyleOption', widget: QWidget) -> QtCore.QRect: ...  # type: ignore  # fix issue #2
    def sizeFromContents(self, type: QStyle.ContentsType, option: 'QStyleOption', size: QtCore.QSize, widget: QWidget) -> QtCore.QSize: ...  # type: ignore  # fix issue #2
    def drawItemPixmap(self, painter: QtGui.QPainter, rect: QtCore.QRect, alignment: int, pixmap: QtGui.QPixmap) -> None: ...
...
class QSpinBox(QAbstractSpinBox):
    ...
    valueChanged: QtCore.pyqtSignal  # fix issue #5
...
class QSplashScreen(QWidget):
    ...
    def repaint(self) -> None: ...  # type: ignore  # fix issue #2
...
class QStackedLayout(QLayout):
    ...
    def addWidget(self, w: QWidget) -> int: ...  # type: ignore  # fix issue #2
...
class QTableWidget(QTableView):
    ...
    def closePersistentEditor(self, item: QTableWidgetItem) -> None: ...  # type: ignore  # fix issue #2
    def openPersistentEditor(self, item: QTableWidgetItem) -> None: ...  # type: ignore  # fix issue #2
...
class QTreeWidget(QTreeView):
    ...
    def closePersistentEditor(self, item: QTreeWidgetItem, column: int = ...) -> None: ...  # type: ignore  # fix issue #2
    def openPersistentEditor(self, item: QTreeWidgetItem, column: int = ...) -> None: ...  # type: ignore  # fix issue #2
