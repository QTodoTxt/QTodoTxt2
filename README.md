...
1. sudo apt-get install python3-pyqt5 qml-module-qtqml-models2 python3-pyqt5.qtquick qml-module-qtquick-controls qml-module-qtquick-dialogs qml-module-qt-labs-settings qml-module-qt-labs-folderlistmodel python3-dateutil
